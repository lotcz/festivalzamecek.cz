...
{get_combined_scripts load='header'}
	...
	<link rel="stylesheet" type="text/css" href="http://festivalzamecek.cz/themes/festivalzamecek/css/style.css">
...
{if $BODY_ID != 'thePicturePage'}
        ...
        <nav class="navbar navbar-default navbar-main" role="navigation">
            <div class="container">
				...
				<a style="font-size:20px;float:right;" href="http://www.festivalzamecek.cz" title="festival Zámeček" >
					<span class="glyphicon glyphicon-share-alt"></span>
					přejít na stránky festivalzamecek.cz					
				</a>
